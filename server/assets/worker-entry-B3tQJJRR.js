...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-CUVT53gL.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-JpFBccO9.js").then((n2) => n2.r),
...
var ROUTER_BASEPATH = "c-blec-v1";
var SERVER_FN_BASE = "/c-blec-v1/_serverFn/";
