...
const appCss = "/c-blec-v1/assets/styles-Cnn7Wd2_.css";
const brandLogo = "/c-blec-v1/assets/logo%202-Bp9lPpjN.svg";
const links = [
  { to: "/", label: "Home" },
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            style: {
              ...
              boxShadow: scrolled ? "inset 0 0 18px rgba(255,255,255,0.22), inset 0 1px 0 rgba(255,255,255,0.6), 0 22px 44px rgba(15, 23, 42, 0.16)" : "inset 0 0 14px rgba(255,255,255,0.18), inset 0 1px 0 rgba(255,255,255,0.5), 0 16px 34px rgba(15, 23, 42, 0.12)"
            },
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Link,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "hidden md:flex items-center gap-10", children: links.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: l.to, className: "nav-link", children: l.label }, l.to)) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden md:block", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/contact", className: "btn-nav", children: "Free Month →" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block w-6 h-px bg-[#0A0A0A]" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block w-6 h-px bg-[#0A0A0A]" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block w-6 h-px bg-[#0A0A0A]" })
                  ]
                }
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block w-6 h-px bg-[#2C596D] rotate-45 absolute" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block w-6 h-px bg-[#2C596D] -rotate-45 absolute" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "flex flex-col items-center gap-8", children: links.map((l, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            Link,
            {
              to: l.to,
              onClick: () => setOpen(false),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("style", { children: `@keyframes fadeUpMobile { from { opacity: 0; transform: translateY(20px);} to { opacity: 1; transform: translateY(0);} }` })
        ]
      }
    )
  ] });
}
const onlyLogo = "data:image/svg+xml,%3c?xml%20version='1.0'%20encoding='UTF-8'?%3e%3csvg%20id='Layer_1'%20data-name='Layer%201'%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%20359.67%20366.73'%3e%3cdefs%3e%3cstyle%3e%20.cls-1%20{%20stroke:%20%23000;%20stroke-linecap:%20round;%20stroke-linejoin:%20round;%20stroke-width:%205px;%20}%20%3c/style%3e%3c/defs%3e%3cpath%20class='cls-1'%20d='M2.54,2.5l-.04,188.94c-.02,95.41,77.31,172.77,172.72,172.77h181.94s0-122.88,0-122.88h-43.05v65.28c0,7.95-6.45,14.4-14.4,14.4h-120.82c-74.58,0-135.04-60.46-135.04-135.04V58.43c0-7.82,6.34-14.16,14.16-14.16h117.12c77.48,0,140.29,62.81,140.29,140.29h0c0,8.32,6.74,15.06,15.06,15.06h26.67s0-15.56,0-15.56C357.17,83.79,275.88,2.5,175.61,2.5H2.54Z'/%3e%3cg%3e%3cpath%20d='M274.79,224.41c-12.7,19.79-35.55,29.64-56.46,24.85-26.99-6.18-46.84-35.84-38.05-64.8,8.72-28.75,41.26-42.34,67.11-32.95,20.41,7.41,34.38,28.34,34.13,52.05-.25-1.29-3.07-14.66-15.87-20.36-1.69-.75-12.26-5.24-23.03.5-8.12,4.33-12.81,12.58-13.47,20.69-.99,12.28,7.23,24.91,19.81,28.02,14.34,3.55,25.36-7.5,25.84-8Z'/%3e%3cpath%20d='M283.58,186.82c.38-44.52-26.56-84.49-66.94-99.82-45.73-17.36-97.96.95-123.49,40.52-20.34,31.52-20.71,71.88-3.82,103.83,19.65,37.16,61.04,59.89,102.97,55.04,45.15-5.22,69.97-39.99,73.9-45.7-2.82,3.24-27.98,31.2-66.6,28.18-28.71-2.24-46.64-20.18-50.84-24.63-6.82-7.23-17.7-21.5-20.67-42.37-3.78-26.57,7.74-46.45,11.31-52.11,3.35-5.32,15.23-22.71,38.71-31.46,4.38-1.63,29.86-10.67,58.05,1.41,18.92,8.11,29.53,21.65,34.01,28.27,10.78,15.95,12.88,31.63,13.4,38.84Z'/%3e%3c/g%3e%3c/svg%3e";
const navLinks = [
  { to: "/", label: "Home" },
  { to: "/how-it-works", label: "How It Works" },
  { to: "/services", label: "Services" },
...
function SiteFooter() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { style: { background: "#0A0A0A", borderTop: "1px solid #2C596D" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-[1200px] px-6 py-20 grid gap-12 md:grid-cols-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-1", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-body mt-3", style: { fontWeight: 300, fontSize: 12, color: "rgba(247,243,238,0.4)" }, children: "Record & Relax" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-3", children: navLinks.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        Link,
        {
          to: l.to,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-3 md:items-end", children: ["thejo@cblec.com", "shameem@cblec.com"].map((e) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "a",
        {
          href: `mailto:${e}`,
          className: "footer-link",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { borderTop: "1px solid rgba(247,243,238,0.08)" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: "© 2025 C-BLEC. All rights reserved."
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: "Strictly Confidential"
        }
      )
    ] }),
...
function NotFoundComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center px-4", style: { background: "var(--bg)" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "label-eyebrow mb-6", children: "Error 404" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "h-display-1", children: "Lost in the cut." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4", style: { color: "var(--text-muted)" }, children: "This page doesn't exist — or it's still on the timeline." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: "btn-outline", children: "Return Home →" }) })
  ] }) });
}
const Route$5 = createRootRoute({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "C-BLEC is a premium video post-production agency. You record. We handle editing, thumbnails, captions, and scheduling — delivered in 24 to 72 hours."
      },
...
function RootComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "pt-[68px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(SiteFooter, {})
  ] });
}
const $$splitComponentImporter$4 = () => import("./services-BDjhNaNf.js");
const Route$4 = createFileRoute("/services")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "End-to-end post-production: editing, thumbnails, captions, posting."
    }, {
      property: "og:title",
      content: "Services — C-BLEC"
    }, {
      property: "og:description",
      content: "Everything after the recording. Handled."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./how-it-works-Dt-5-Ze4.js");
const Route$3 = createFileRoute("/how-it-works")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Four steps from recording to live."
    }, {
      property: "og:title",
      content: "How It Works — C-BLEC"
    }, {
      property: "og:description",
      content: "Record. Send. We handle it. Live."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./contact-Cpn9wnk-.js");
const Route$2 = createFileRoute("/contact")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Tell us about your content goals. We typically respond within 24 hours."
    }, {
      property: "og:title",
      content: "Contact — C-BLEC"
    }, {
      property: "og:description",
      content: "Get in touch with C-BLEC's post-production team."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./about-BsuXDpxc.js");
const Route$1 = createFileRoute("/about")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Built for people who don't have time to edit."
    }, {
      property: "og:title",
      content: "About — C-BLEC"
    }, {
      property: "og:description",
      content: "The team behind C-BLEC."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./index-BifFGN12.js");
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "You record. We handle editing, thumbnails, captions, and scheduling — delivered in 24 to 72 hours."
    }, {
      property: "og:title",
      content: "C-BLEC — Record & Relax"
    }, {
      property: "og:description",
